...
$(document).ready(function () {
  ...
  if (dt_technician_table.length) {
    ...
    $("#partenaireTab .head-label").html(
      '<h5 class="card-title mb-0">Partenaire</h5>'
    );
  }
  ...
  if (dt_ingenieur_table.length) {
    const dt_ingenieur = dt_ingenieur_table.DataTable({
      ...
      buttons: [
        ...
        },
        {
          ...
          className: "create-new-ing btn btn-primary",
        },
      ],
      responsive: {
        details: {
    ...
    $("#ingenieurTab .head-label").html(
      '<h5 class="card-title mb-0">Ingénieur</h5>'
    );
  }

  var dt_delegataire_table = $(".datatables-delegataire");
  if (dt_delegataire_table.length) {
    const dt_delegataire = dt_delegataire_table.DataTable({
      order: [[0, "asc"]],
      scrollX: true,
      language: {
        lengthMenu: "Afficher _MENU_ Lines",
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Ajouter un délégataire</span>',
          className: "create-new-deleg btn btn-primary",
        },
      ],
      responsive: {
        details: {
    ...
    $("#delegataireTab .head-label").html(
      '<h5 class="card-title mb-0">Délégataire</h5>'
    );
  }
});
